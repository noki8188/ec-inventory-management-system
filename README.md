...
- 現行バージョン: `v1.1.0`
- 最新更新: 管理画面のライト / ダークテーマ切り替えを追加

## 最新アップデート

- 管理画面で暗色モードを切り替えられるテーマトグルを追加
- 管理ダッシュボード、ナビゲーション、入力欄、テーブル配色をダークテーマ対応
- README に管理画面のダークテーマキャプチャを追加
...
![管理ダッシュボード ダークテーマ](docs/demo-screenshots/06-admin-dark-mode.png)
